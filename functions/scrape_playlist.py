...
def scrape_playlist(html, station_name, date_str=None):
    ...
    Künstler und Titel. Die gewonnenen Daten werden als Dictionary für die PostgreSQL-Datenbank vorbereitet.
    ...
    for program in programs:
        ...
        if time_elem is None or h3_elem is None:
            continue  # Überspringen, wenn wichtige Teile fehlen
        ...
        # Kombiniere Datum + Zeit zu einem vollständigen Timestamp
        played_at = f"{date_str} {played_time}:00"
